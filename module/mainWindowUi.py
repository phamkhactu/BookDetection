...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(510, 450, 91, 41))
        ...
        self.label_3.setGeometry(QtCore.QRect(510, 500, 111, 17))
        self.label_3.setObjectName("label_3")
        self.lable_status = QtWidgets.QLabel(self.centralwidget)
        self.lable_status.setGeometry(QtCore.QRect(670, 460, 67, 17))
        ...
        self.label_da_doc.setGeometry(QtCore.QRect(670, 500, 67, 17))
        ...
        self.image_crop = QtWidgets.QLabel(self.centralwidget)
        self.image_crop.setGeometry(QtCore.QRect(510, 70, 331, 301))
        self.image_crop.setText("")
        self.image_crop.setObjectName("image_crop")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(510, 410, 91, 41))
        self.label_2.setObjectName("label_2")
        self.lable_thong_bao = QtWidgets.QLabel(self.centralwidget)
        self.lable_thong_bao.setGeometry(QtCore.QRect(670, 420, 211, 17))
        self.lable_thong_bao.setText("")
        self.lable_thong_bao.setObjectName("lable_thong_bao")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "Thông báo:"))
